...
export type GetCartItemQuery = { __typename?: 'Query', cartItem: { __typename?: 'CartItem', quantity: number }, product?: { __typename?: 'Product', name: string, imageUrl: string, price: number, availableQuantity: number, description?: string | null, limitPerTransaction: number } | null };
