...
export type ListOrdersQuery = { __typename?: 'Query', orders: { __typename?: 'PaginatedOrder', items: Array<{ __typename?: 'Order', orderId: string, userId: string, deliveryStatus: DeliveryStatus, paymentMethod: PaymentMethod, createdAt: string, updatedAt: string, canCancel: boolean, items: Array<{ __typename?: 'OrderItem', productId: string, quantity: number, price: number, product?: { __typename?: 'Product', name: string, imageUrl: string, price: number, unit: string } | null }>, shippingAddress: { __typename?: 'Address', apt?: string | null, street: string, city: string, state: string, zip: string, country: string, additionalInfo?: string | null }, review?: { __typename?: 'OrderReview', rating: number, comment: string } | null, contactDetails: { __typename?: 'DeliveryContactDetails', name: string, phone: string, email: string }, checkoutDetails: { __typename?: 'CheckoutDetails', totalPrice: number, subTotal: number, tax: number, discount: number, deliveryPrice: number, taxPercentage: number } }>, pagination: { __typename?: 'Pagination', next?: string | null } } };
...
export type CheckoutPageQuery = { __typename?: 'Query', cart: { __typename?: 'Cart', items: Array<{ __typename?: 'CartItem', quantity: number, product?: { __typename?: 'Product', name: string, price: number, productId: string, imageUrl: string, availableQuantity: number, unit: string, badgeText: string, category: string } | null }>, checkoutDetails: { __typename?: 'CheckoutDetails', subTotal: number, totalPrice: number, tax: number, taxPercentage: number, deliveryPrice: number, enableCheckout: boolean } }, me?: { __typename?: 'User', email?: string | null, name?: string | null, phone?: string | null, defaultAddress?: { __typename?: 'Address', apt?: string | null, street: string, zip: string } | null } | null };
