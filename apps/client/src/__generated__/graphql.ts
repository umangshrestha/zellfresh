...
export type ListCartsVerboseQueryVariables = Exact<{ [key: string]: never; }>;


export type ListCartsVerboseQuery = { __typename?: 'Query', cart: { __typename?: 'Cart', items: Array<{ __typename?: 'CartItem', quantity: number, product?: { __typename?: 'Product', productId: string, category: string, name: string, unit: string, price: number, imageUrl: string, badgeText: string, availableQuantity: number, limitPerTransaction: number, description?: string | null } | null }>, checkoutDetails: { __typename?: 'CheckoutDetails', subTotal: number, enableCheckout: boolean } } };
...
export type CheckoutPageQuery = { __typename?: 'Query', cart: { __typename?: 'Cart', items: Array<{ __typename?: 'CartItem', quantity: number, product?: { __typename?: 'Product', name: string, price: number, imageUrl: string, availableQuantity: number, description?: string | null, unit: string, badgeText: string, category: string } | null }>, checkoutDetails: { __typename?: 'CheckoutDetails', subTotal: number, totalPrice: number, tax: number, taxPercentage: number, deliveryPrice: number, enableCheckout: boolean } }, me?: { __typename?: 'User', email?: string | null, name?: string | null, phone?: string | null, defaultAddress?: { __typename?: 'Address', apt?: string | null, street: string, zip: string } | null } | null };
